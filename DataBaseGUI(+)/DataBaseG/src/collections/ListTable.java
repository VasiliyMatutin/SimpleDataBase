...
public class ListTable implements Serializable, Table {
	private static final long serialVersionUID = -4824000504495425014L;
	private LinkedList<Row> table_list = new LinkedList<Row>();
	private HashFunction hf;
	
	public ListTable(){}
	
	public ListTable(HashFunction _hf){
		hf = _hf;
	}
